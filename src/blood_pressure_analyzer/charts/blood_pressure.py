...
def draw_blood_pressure_chart_with_recommendations(df: pd.DataFrame) -> None:
    ...
    if range_selection == ColumnNames.SYSTOLIC:
        ...
        fig.add_hrect(
            ...
            fillcolor="green",
            opacity=0.1,
            annotation_text="Sys Normal (<120)",
        ...
        fig.add_hrect(
            ...
            fillcolor="yellow",
            opacity=0.2,
            annotation_text="Sys Elevated (120-129)",
            annotation_position="top left",
            secondary_y=False,
        )
        ...
        fig.add_hrect(
            ...
            fillcolor="orange",
            opacity=0.2,
            annotation_text="Sys Stage 1 Hypertension (130-139)",
            annotation_position="top left",
            secondary_y=False,
        )
        ...
        fig.add_hrect(
            ...
            fillcolor="red",
            opacity=0.2,
            annotation_text="Sys Stage 2 Hypertension (140-180)",
            annotation_position="top left",
            secondary_y=False,
        )
        ...
        fig.add_hrect(
            ...
            fillcolor="darkred",
            opacity=0.3,
            annotation_text="Sys Severe Hypertension (>180)",
            annotation_position="top left",
            secondary_y=False,
        )
    ...
    if range_selection == ColumnNames.DIASTOLIC:
        ...
        fig.add_hrect(
            ...
            fillcolor="orange",
            opacity=0.2,
            annotation_text="Dia Stage 1 Hypertension (80-89)",
            annotation_position="top right",
            secondary_y=False,
        )
        ...
        fig.add_hrect(
            ...
            fillcolor="red",
            opacity=0.2,
            annotation_text="Dia Stage 2 Hypertension (90-120)",
            annotation_position="top right",
            secondary_y=False,
        )
        ...
        fig.add_hrect(
            ...
            fillcolor="darkred",
            opacity=0.3,
            annotation_text="Dia Severe Hypertension (>120)",
            annotation_position="top right",
            secondary_y=False,
        )
...
def draw_systolic_chart(df: pd.DataFrame, rolling_median_period: int) -> None:
    ...
    rolling_median = series.rolling(
        window=rolling_median_period, center=True, min_periods=1
    ).median()
